...
public class ToolAxe extends ItemTool implements IHasModel
{
    ...
    public float getStrVsBlock(ItemStack stack, IBlockState state)
    {
        ...
        return material != net.minecraft.block.material.Material.WOOD && material != net.minecraft.block.material.Material.PLANTS && material != Material.VINE ? 1 : this.toolMaterial.getEfficiency();
    }
