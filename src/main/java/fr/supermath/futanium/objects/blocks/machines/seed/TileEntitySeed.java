...
import fr.supermath.futanium.objects.blocks.machines.seed.slot.SlotSeedFuel;
...
public class TileEntitySeed extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.seed";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntitySeed.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                SeedFabricator.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = SeedRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = SeedRecipes.instance().getCookingResult(itemstack);
    ...
    public static int getItemBurnTime(ItemStack stack)
    {
        ...
        {
            int burnTime = Items.WHEAT_SEEDS.getItemBurnTime(stack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        {
            ItemStack itemStack = this.furnaceItemStacks.get(1);
            return isItemFuel(stack) || SlotSeedFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
        }
    }
    ...
    {
        return new ContainerSeed(playerInventory, this);
    }
