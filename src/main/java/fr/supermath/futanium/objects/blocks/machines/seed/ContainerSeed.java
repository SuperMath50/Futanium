...
import fr.supermath.futanium.objects.blocks.machines.seed.slot.SlotSeedOutput;
...
public class ContainerSeed extends Container
{
    private final IInventory tileFurnace;
    private int cookTime, totalCookTime, ovenBurnTime, currentItemBurnTime;

    public ContainerSeed(InventoryPlayer playerInventory, IInventory furnaceInventory)
    {
        this.tileFurnace = furnaceInventory;
        this.addSlotToContainer(new Slot(furnaceInventory, 0, 56, 17));
        this.addSlotToContainer(new SlotSeedFuel(furnaceInventory, 1, 56, 53));
        this.addSlotToContainer(new SlotSeedOutput(playerInventory.player, furnaceInventory, 2, 116, 35));
    ...
    public ItemStack transferStackInSlot(EntityPlayer playerIn, int index)
    {
        ...
        if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (!SeedRecipes.instance().getCookingResult(itemstack1).isEmpty())
                {
                ...
                else if (TileEntitySeed.isItemFuel(itemstack1))
                {
