...
import fr.supermath.futanium.objects.blocks.machines.oven.slot.SlotOvenFurnaceFuel;
...
public class TileEntityOven extends TileEntityLockable implements ITickable, ISidedInventory
{
    ...
    {
        return this.hasCustomName() ? this.furnaceCustomName : "container.oven_furnace";
    }
    ...
    {
        fixer.registerWalker(FixTypes.BLOCK_ENTITY, new ItemStackDataLists(TileEntityOven.class, new String[] {"Items"}));
    }
    ...
    public void update()
    {
        ...
        if (!this.world.isRemote)
        {
            ...
            {
                flag1 = true;
                OvenFurnace.setState(this.isBurning(), this.world, this.pos);
            }
        }
    ...
    private boolean canSmelt()
    {
        ...
        {
            ItemStack itemstack = OvenRecipes.instance().getCookingResult(this.furnaceItemStacks.get(0));
    ...
    public void smeltItem()
    {
        if (this.canSmelt())
        {
            ...
            ItemStack itemstack1 = OvenRecipes.instance().getCookingResult(itemstack);
    ...
    public boolean isItemValidForSlot(int index, ItemStack stack)
    {
        ...
        {
            ItemStack itemStack = this.furnaceItemStacks.get(1);
            return isItemFuel(stack) || SlotOvenFurnaceFuel.isBucket(stack) && itemStack.getItem() != Items.BUCKET;
        }
    }
