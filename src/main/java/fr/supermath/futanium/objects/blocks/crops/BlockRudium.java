package fr.supermath.futanium.objects.blocks.crops;
...
public class BlockRudium extends BlockCrops
{
    ...
    {
        return ItemInit.RUDIUM_SEED;
    }

    protected Item getCrop()
    {
        return ItemInit.RUDIUM;
    }
    ...
    public void getDrops(net.minecraft.util.NonNullList<ItemStack> drops, IBlockAccess world, BlockPos pos, IBlockState state, int fortune)
    {
        ...
        if (age >= getMaxAge())
        {
            ...
            for (int i = 0; i < 3 + fortune; ++i)
            {
                ...
                {
                    drops.add(new ItemStack(this.getSeed(), 0, 0));
                }
            }
        }
    }
